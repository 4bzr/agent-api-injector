...
from cert.utils.utils import Version, ExecName, InternalUI

arg_parser = argparse.ArgumentParser()
arg_parser.add_argument("--debug", dest="debug_mode", action="store_true")

main_dir = os.path.dirname(os.path.abspath(__file__))
init_script_path = os.path.join(main_dir, "cert", "init_script")
...
with open(os.path.join(main_dir, "cert", "init_script.py"), "w") as file:
